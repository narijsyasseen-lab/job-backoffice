...
<div class="mt-4">
   ...
   <x-input-label for="password" :value="__('Password')" /> 
    ...
    <div class="relative mt-1" x-data="{ showPassword: false }">
        ...
        <x-text-input id="password" class="block w-full pr-12" x-bind:type="showPassword ? 'text' : 'password'" name="password"
        ...
        <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500">
            ...
            <!-- Eye Closed -->
            <svg
                x-show="!showPassword" x-cloak class="w-5 h-5" viewBox="0 0 24 24" fill="none"
